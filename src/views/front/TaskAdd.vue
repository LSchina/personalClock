...
<div id="add_container">
  ...
  <div style="width: 100%;height: 45%;margin-top: 4%;display: flex">
    <div style="padding: 3vh 10vw 3vh 10vw;box-sizing: border-box;width: 100%;height: 100%;margin: auto;background-color: white;border-radius: 1rem">
      <div style="width: 100%;height: 12%;display: flex;justify-content: space-between">
        <div style="width: 15%;height: 100%;display: flex">
          <div style="letter-spacing: 0.2rem;font-size: 1rem;color: black">主题</div>
        </div>
        <div style="width: 80%;height: 100%;display: flex">
          <van-field style="background-color: #f5f4f4" v-model="saveForm.theme"  />
        </div>
      </div>
      <div style="margin-top: 3%;width: 100%;height: 12%;display: flex;justify-content: space-between">
        <div style="width: 15%;height: 100%;display: flex">
          <div style="letter-spacing: 0.2rem;font-size: 1rem;color: black">名称</div>
        </div>
        <div style="width: 80%;height: 100%;display: flex">
          <van-field style="background-color: #f5f4f4" v-model="saveForm.name"  />
        </div>
      </div>
      <div style="margin-top: 3%;width: 100%;height: 28%;display: flex;justify-content: space-between">
        <div style="width: 15%;height: 100%;display: flex">
          <div style="letter-spacing: 0.2rem;font-size: 1rem;color: black">内容</div>
        </div>
        <div style="width: 80%;height: 100%;display: flex">
          <van-field
      ...
      <div style="margin-top: 3%;width: 100%;height: 12%;display: flex;justify-content: space-between">
        <div style="width: 15%;height: 100%;display: flex">
          <div style="letter-spacing: 0.2rem;font-size: 1rem;color: black">时间</div>
        </div>
        <div style="width: 85%;height: 100%;display: flex;justify-content: left">
          <van-stepper style="background-color: #f5f4f4;margin: auto" v-model="saveForm.duration"/>
        </div>
      </div>
